...
def email_login_no_turnstile_token__test(client: django.test.Client, ru, respx_mock):
    """ User should see an error if turnstile token is missing """
    ...
    # WHEN user submits email login form without turnstile_token
