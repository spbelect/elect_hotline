...
def google_login_invalid_state_secret__test(client: django.test.Client, ru, respx_mock):
    """
    User should see error messages if google oauth redirect callback receives
    wrong state secret in GET request query argument.
    """
    ...
    # WHEN google redirects to callback page with 'state' parameter != google_oauth2_state_secret
